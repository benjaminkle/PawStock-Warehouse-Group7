...
INSERT INTO products (
    product_name, description, price, pet_type, size, quantity,
    brand_id, category_id, supplier_id, created_at
)
VALUES (
    'Adult Dog Dry Food',
    'Balanced dry food formulated for adult dogs.',
    69.99, 'Dog', '12 kg', 9, 1, 1, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    54.99, 'Cat', '7 kg', 56, 1, 1, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    29.49, 'Dog', '12 x 385 g', 17, 1, 1, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    18.99, 'Dog', 'Medium', 5, 2, 2, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    15.49, 'Dog', 'Small', 12, 2, 2, 3, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    10.99, 'Cat', 'One Size', 24, 2, 2, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    12.99, 'Fish', '200 g', 3, 3, 1, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    7.49, 'Fish', '35 g', 20, 3, 1, 3, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    14.99, 'Fish', '250 mL', 63, 3, 5, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    24.99, 'Small Animal', '2.25 kg', 32, 4, 1, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    19.99, 'Small Animal', '1.1 kg', 44, 4, 1, 3, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    22.49, 'Small Animal', '2.25 kg', 23, 4, 1, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    13.99, 'Bird', '1.8 kg', 85, 5, 1, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    59.99, 'Small Animal', 'Medium', 57, 5, 4, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    129.99, 'Reptile', '20 gallon', 8, 5, 4, 3, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    16.99, 'Dog', 'Medium', 33, 5, 3, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    11.49, 'Cat', 'Small', 9, 5, 3, 2, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    14.99, 'Dog', '1.5 L', 30, 5, 5, 3, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    21.99, 'Dog', '1.8 m', 40, 5, 5, 1, CURRENT_TIMESTAMP
);
...
VALUES (
    ...
    34.99, 'Reptile', '150 W', 75, 5, 5, 3, CURRENT_TIMESTAMP
);
